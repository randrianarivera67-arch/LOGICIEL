...
{id:'s11',name:'FL Studio 2026',type:'Logiciel',category:'DAW',os:'Windows',version:'2026.1',size:'1.2 Go',dl:388210,rate:4.5,price:'70 000 Ar',image:'',link:'https://www.image-line.com',date:'2026-08-10',info:"DAW complet : composition, mixage, mastering, lifetime updates.",install:"Téléchargez\nExécutez l'installateur\nChoisissez les composants\nLancez FL Studio\nActivez votre licence"},
...
function renderStats(){var a=gid('statCount'),b=gid('statLog'),d=gid('statApp');if(a)a.textContent=state.list.length;if(b)b.textContent=state.list.filter(function(i){return(i.type||'Logiciel')==='Logiciel'}).length;if(d)d.textContent=state.list.filter(function(i){return i.type==='Application'}).length}
