...
if(i===1){startChat();var o=document.querySelectorAll('.osic');for(var k2=0;k2<o.length;k2++){(function(el,d){setTimeout(function(){el.classList.add('on')},d)})(o[k2],200+k2*300)}}
