...
g('pmModal').innerHTML='<h3 style="font-family:Sora">💳 Paiement — '+escS(curItem.name)+'</h3><p style="color:var(--amber);font-family:Sora;font-weight:800;font-size:1.2rem;margin:6px 0">'+escS(curItem.price||'—')+'</p><p style="color:var(--muted);font-size:.84rem">Choisissez le moyen de paiement :</p><div class="pm-methods">'+mh+'</div><button class="btn ghost big" style="margin-top:4px" onclick="closePay()">Annuler</button>';
